        ...
        <aside id="sidebar" class="sidebar-nav col-sm-2">
            <nav class="sidebar-nav">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="">
                        <a class="has-arrow" id="Item1_0"><span class="fa fa-fw fa-book fa-lg"></span>备忘录管理</a>
                        <ul class="mm-collapse">
                            <li><a href="${cx}/notes/create" id="Item1_1">
                                添加备忘录</a></li>
                            <li><a href="${cx}/notes/list"
                                   id="Item1_2">查看备忘录
                            </a></li>
                            <!--<li><a href="${cx}/notes/comment" id="Item1_3">
                                <%--备忘录评论</a></li>--%>
                            <li><a href="44#" id="Item1_4">已提交备忘录</a></li>-->
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="mm-collapse">
                            <li><a href="6#" aria-expanded="false"
