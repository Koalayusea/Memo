...
<div class="form-signin">
    <div class="text-center">
        <img src="${cx}/resource/static/img/logo.png" alt="夙景科技公司">
    </div>
    <hr>
    <div class="tab-content">
        ...
        <div id="signup" class="tab-pane">
            <form action="${cx}/signup" method="POST">
                <input name="username" type="text" placeholder="输入用户名" class="form-control top">
                <input name="email" type="email" placeholder="输入email地址(mail@domain.com)"
